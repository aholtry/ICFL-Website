mainApp.controller('individualStatsCtrl', function ($scope, $rootScope, $log, $location, $timeout, $window, mainFactory) {
    ...
    $scope.loadIndividualStats = function () {
        ...
        $scope.offStats = Enumerable.From($scope.manOffStats)
                            ...
                            .GroupBy("{team: $.team, num: $.num}", null,
                                function (key, g) {
                                    var result = {
                                        num: key.num,
                                        team: key.team,
                                    ...
                                    return result;
                                }, function (x) { return x.num + ':' + x.team })
                            .ToArray();
